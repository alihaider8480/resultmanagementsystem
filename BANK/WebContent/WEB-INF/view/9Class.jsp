    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown navbar-nav-top-padding" data-app-modern-menu="true"><li class="nav-item dropdown">
                ...
                </li> </a></li><li class="nav-item"><a class="nav-link link text-primary display-4" href="http://localhost:8080/BANK/" aria-expanded="true"><span class="mbri-home mbr-iconfont mbr-iconfont-btn" style="font-size: 30px;">Home</span>
...
<h1 align="center"><br><br><br>Insert 9th Class Student Records<br><br></h1>
 <form action="http://localhost:8080/BANK/Insert_Nine_Class_Result"  method="post">
               <h6  align="center" style="color: red">${cheack} </h6>
  	<table BORDER=10 BORDERCOLOR="#0000FF" BORDERCOLORLIGHT="#33CCFF" BORDERCOLORDARK="#0000CC" cellpadding="10%" align="Center">
        ...
        <tr>
         <td>Sindhi</td>
         <td><input type="text" name="sindhi" required></td>
        </tr>
         <tr> 
          <td><input type="radio" name="check_com_bio" value="Com" required>Computer<br><input type="radio" name="check_com_bio" value="Bio">Biology</td>
          <td><input type="text" name="computer_biology" required></td>
        </tr>       
        <tr>
            <td>Physics</td>
            <td><input type="text" name="physics" required></td>
        </tr>
        <tr>
            <td>Math</td>
